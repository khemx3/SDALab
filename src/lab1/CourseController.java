...
/**
 * Presents a given view of a set of courses and their marks. Uses the push.Observer
 * lab1.pattern to be notified when a new course has been added.
 */
...
public class CourseController extends JPanel implements Observer, ChangeListener, ActionListener {
	...
	public static void main(String[] args) {
		...
		JFrame frame = new JFrame("push.Observer Pattern");
